...
2010년 4월 23일부터 시행되던 종전의 약관은 본 약관으로 대체됩니다. 
					...
					<div class="mt10">
						<label class="input-sp">
							<input type="checkbox" class="chk" value="Y" />
...
*이전 개인정보취급방침 보기(2014년 2월 1일부터 시행된 방침) 
			...
			<div class="all-agree-box">
				<label class="input-sp" id="checkAll">
			...
			<div class="box-btn">
				<a href="javascript:void(0)" onclick="func_phone();" class="btn-l">다음단계 (휴대폰인증)</a>
			</div>
...
<!--<script>
    $(".all-agree-box").on("click", function() {
