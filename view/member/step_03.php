...
<div id="container" class="container-full">
	<div id="content" class="content">
		<div class="inner">
			...
			<form class="section-content" id="SignUp" method="post">
				<table border="0" cellpadding="0" cellspacing="0" class="tbl-col-join">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" class="input-text" id="userId" name= "userId" style="width:302px" placeholder="영문자로 시작하는 4~15자의 영문소문자, 숫자" required/><a href="#idResult" class="btn-s-tin ml10" id="idEnrollChk">중복확인</a></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" class="input-text" id="p1" name="p1" style="width:50px" value=<?php echo $_POST["p1"];?> readonly="readonly" required /> -
								<input type="text" class="input-text" id="p2" name="p2" style="width:50px" value=<?php echo $_POST["p2"];?> readonly="readonly" required /> -
								<input type="text" class="input-text" id="p3" name="p3" style="width:50px" value=<?php echo $_POST["p3"];?> readonly="readonly" required/>
							</td>
						</tr>
						<tr>
